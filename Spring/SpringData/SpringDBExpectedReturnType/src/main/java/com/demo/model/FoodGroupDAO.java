...
public class FoodGroupDAO {
	...
	private JdbcTemplate myBasicJDBCTemplate;
	...
	public void setMyJDBCTemplate(DataSource ds) {
		...
		this.myBasicJDBCTemplate = new JdbcTemplate(ds);
	}
	...
	public void demoMethod() {
		Integer value = myBasicJDBCTemplate.queryForObject("Select count(*) from foodgroups",Integer.class);
		
		System.out.println("Value-"+value);
		String value_str = myBasicJDBCTemplate.queryForObject("Select name from foodgroups where id=1",String.class);
		System.out.println("value_str-"+value_str);
	}
