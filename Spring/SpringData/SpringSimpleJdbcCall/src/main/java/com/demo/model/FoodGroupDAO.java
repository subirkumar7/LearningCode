...
public class FoodGroupDAO {
	...
	public FoodGroup readFoodGroup(int groupID) {
		MapSqlParameterSource params = new MapSqlParameterSource();
		params.addValue("p_id", groupID);
		
		Map<String, Object> outValues  = procReadFoodGroup.execute(params);
		
		System.out.println((String)outValues.get("p_name"));
		System.out.println((String)outValues.get("p_description"));

		FoodGroup fg = new FoodGroup();
		fg.setId(groupID);
		fg.setName((String)outValues.get("p_name"));
		fg.setDescription((String)outValues.get("p_description"));
